...
class EmployeeProject(db.Model):
    """Mapping of employees to project"""
...
# SQL Version 
# SELECT employees.name, departments.dept_code, departments.phone 
# FROM employees 
# LEFT JOIN departments ON employees.dept_code = departments.dept_code;
